...
public class GuiMain {
	 ...
	 * 	 */
	private static final String VERSION = "0.1.3-16.12.2010";
	...
	private static final Dimension framesize = new Dimension(700,450 );
	...
	private String[] s = new String[]{"Gruppe", "Vorname", "Name", "Geburtsdatum", "eMail", "URL", "Adresse", "Telefonnr.", "Job"};
	...
	public void setData(Object o) {
		...
		ta.setText(editPerson.getAddress().toString());
		tf[7].setText(editPerson.getTelephone());
		tf[8].setText(editPerson.getJob());
		disableTextFields();
	}
	...
	private void saveData(Object o, int i) {
		...
		// Addresse fehlt noch editPerson.setLastName(tf[6].getText());
		
		editPerson.setTelephone(tf[7].getText());
		editPerson.setJob(tf[8].getText());
